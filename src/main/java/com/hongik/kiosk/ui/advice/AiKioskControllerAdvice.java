...
public class AiKioskControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AiKioskException.class)
    public ResponseEntity<?> opMessageException(AiKioskException ex) {
