...
public class ApiErrorView {
    ...
    public ApiErrorView(AiKioskException exception) {
    ...
    public static class Error {
        ...
        public static Error errorWithException(AiKioskException aiKioskException) {
            return new Error(aiKioskException);
        }
        ...
        private Error(AiKioskException cloudLibraryException) {
